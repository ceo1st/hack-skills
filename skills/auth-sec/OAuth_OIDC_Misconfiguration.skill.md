...
- `JWT_OAuth_Token_Attacks.skill.md`
...
- CORS or cross-origin token exposure: `CORS_Cross_Origin_Misconfiguration.skill.md`
- XML federation or enterprise SSO: `SAML_SSO_Assertion_Attacks.skill.md`
- CSRF-heavy login or binding bugs: `CSRF_Cross_Site_Request_Forgery.skill.md`