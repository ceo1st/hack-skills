...
- XML parser attack depth: `../injection-checking/XXE_XML_External_Entity.skill.md`
- OAuth or OIDC SSO alternatives: `OAuth_OIDC_Misconfiguration.skill.md`
- Auth boundary issues after SSO: `AuthBypass_Authentication_Flaws.skill.md`