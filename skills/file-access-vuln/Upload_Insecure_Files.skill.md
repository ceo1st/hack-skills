...
- `../payloads-for-sec/File_Upload_Payload_Selection.skill.md` for compact first-pass payload families
- `PathTraversal_LFI.skill.md` when filename, extraction path, or include path becomes file-system control
- `../injection-checking/XSS_Cross_Site_Scripting.skill.md` when uploads are rendered in browser contexts
- `../injection-checking/XXE_XML_External_Entity.skill.md` when SVG, OOXML, or XML imports are accepted
- `../injection-checking/CMDi_Command_Injection.skill.md` when a processor, converter, or media pipeline executes system tools
- `../business-logic-vuln/BusinessLogic_Vulnerabilities.skill.md` when quotas, overwrite rules, approvals, or storage paths create logic bugs
...
| Observation | Pivot |
|---|---|
| SVG or XML accepted | `../injection-checking/XXE_XML_External_Entity.skill.md` |
| filename or metadata reflected | `../injection-checking/XSS_Cross_Site_Scripting.skill.md` |
| converter or processor shells out | `../injection-checking/CMDi_Command_Injection.skill.md` |
| extraction path looks controllable | `PathTraversal_LFI.skill.md` |
| overwrite, quota, approval, or tenant bug | `../business-logic-vuln/BusinessLogic_Vulnerabilities.skill.md` |
